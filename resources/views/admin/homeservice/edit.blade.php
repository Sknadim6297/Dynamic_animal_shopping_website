...
<div class="sb2-2">
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="active-bre"><a href="#"> Edit Home Service</a>
            </li>
            <li class="page-back"><a href="{{ route('admin.homeservice.index') }}"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
            </li>
        </ul>
    </div>
    <div class="sb2-2-add-blog sb2-2-1">
        <div class="box-inn-sp">
            <div class="inn-title">
                <h4>Edit Home Service</h4>
                <p>Update service information</p>
            </div>
            <div class="bor">
                <form method="POST" action="{{ route('admin.homeservice.update', $service->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="heading" name="heading" type="text" class="validate" value="{{ old('heading', $service->heading) }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea id="description" name="description" class="materialize-textarea">{{ old('description', $service->description) }}</textarea>
                        ...
                        <div class="input-field col s12">
                            @if($service->video_file)
                                <div style="margin-bottom: 15px;">
                                    <p>Current Uploaded Video:</p>
                                    <video controls style="max-width: 400px; width: 100%; border: 1px solid #ddd; padding: 10px; background: #000;">
                            ...
                            @elseif($service->video)
                                <div style="margin-bottom: 15px;">
                                    ...
                                    <div style="max-width: 400px; border: 1px solid #ddd; padding: 10px;">
                                        <iframe width="100%" height="225" src="{{ $service->video }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                            @endif
                            <input id="video" name="video" type="text" class="validate" value="{{ old('video', $service->video) }}">
                        ...
                        <div class="input-field col s12">
                            @if($service->background_image)
                                <div style="margin-bottom: 15px;">
                                    ...
                                    <img src="{{ asset('storage/' . $service->background_image) }}" alt="Background" style="max-width: 100%; height: auto; border: 1px solid #ddd; padding: 6px;">
                                </div>
                            @endif
                            <div class="file-field input-field" style="margin-top: 0;">
                                <div class="btn">

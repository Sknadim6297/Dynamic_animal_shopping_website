...
<div class="sb2-2">
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="active-bre"><a href="#"> Add Home About</a>
            </li>
        </ul>
    </div>
    <div class="sb2-2-add-blog sb2-2-1">
        <div class="box-inn-sp">
            <div class="inn-title">
                <h4>Add Home About Section</h4>
                <p>Add a new about section for the home page</p>
            </div>
            <div class="bor">
                <form method="POST" action="{{ route('admin.homeabout.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="section_heading" name="section_heading" type="text" class="validate" value="{{ old('section_heading') }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="year_of_experience" name="year_of_experience" type="text" class="validate" value="{{ old('year_of_experience') }}">
                    ...
                    <div style="border: 1px solid #ddd; padding: 15px; margin-bottom: 15px; border-radius: 4px;">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="right_heading_{{ $i }}" name="right_heading_{{ $i }}" type="text" class="validate" value="{{ old('right_heading_' . $i) }}">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea id="right_description_{{ $i }}" name="right_description_{{ $i }}" class="materialize-textarea">{{ old('right_description_' . $i) }}</textarea>

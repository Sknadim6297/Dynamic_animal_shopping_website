...
<div class="sb2-2">
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="active-bre"><a href="#"> Add About Page Section</a>
            </li>
        </ul>
    </div>
    <div class="sb2-2-add-blog sb2-2-1">
        <div class="box-inn-sp">
            <div class="inn-title">
                <h4>Add About Page Section</h4>
                <p>Add a new section for the About page</p>
            </div>
            <div class="bor">
                <form method="POST" action="{{ route('admin.mainabout.store') }}" enctype="multipart/form-data">
                    @csrf

                    <h5 style="margin-top: 20px; margin-bottom: 15px; font-weight: 600;">Main Section</h5>
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="main_heading" name="main_heading" type="text" class="validate" value="{{ old('main_heading') }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="main_heading_highlight" name="main_heading_highlight" type="text" class="validate" value="{{ old('main_heading_highlight') }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea id="main_description" name="main_description" class="materialize-textarea">{{ old('main_description') }}</textarea>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="video_url" name="video_url" type="url" class="validate" value="{{ old('video_url') }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="how_we_work_label" name="how_we_work_label" type="text" class="validate" value="{{ old('how_we_work_label') }}" placeholder="HOW WE WORK">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="years_of_experience" name="years_of_experience" type="text" class="validate" value="{{ old('years_of_experience') }}">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input id="vision_heading" name="vision_heading" type="text" class="validate" value="{{ old('vision_heading') }}">
                            <label for="vision_heading">Vision Heading</label>
                        </div>
                        <div class="input-field col s6">
                            <input id="mission_heading" name="mission_heading" type="text" class="validate" value="{{ old('mission_heading') }}">
                            <label for="mission_heading">Mission Heading</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s6">
                            <textarea id="vision_description" name="vision_description" class="materialize-textarea">{{ old('vision_description') }}</textarea>
                            <label for="vision_description">Vision Description</label>
                        </div>
                        <div class="input-field col s6">
                            <textarea id="mission_description" name="mission_description" class="materialize-textarea">{{ old('mission_description') }}</textarea>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="why_choose_items_{{ $i }}" name="why_choose_items[]" type="text" class="validate" value="{{ old('why_choose_items.' . $i) }}" placeholder="Bullet {{ $i + 1 }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="why_choose_heading" name="why_choose_heading" type="text" class="validate" value="{{ old('why_choose_heading') }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="why_choose_community_text" name="why_choose_community_text" type="text" class="validate" value="{{ old('why_choose_community_text') }}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea id="callout_description" name="callout_description" class="materialize-textarea">{{ old('callout_description') }}</textarea>

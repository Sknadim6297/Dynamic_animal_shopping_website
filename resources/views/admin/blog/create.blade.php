                ...
                <form method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="blog_heading" name="blog_heading" type="text" class="validate" value="{{ old('blog_heading') }}" required>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            ...
                            <textarea id="blog_details" name="blog_details" class="materialize-textarea" rows="10" required>{{ old('blog_details') }}</textarea>
                            @error('blog_details')
                                <span class="red-text">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <select id="blog_category" name="blog_category" class="validate" required>
                                ...
                                <option value="Accessories" {{ old('blog_category') == 'Accessories' ? 'selected' : '' }}>Accessories</option>
                                <option value="Cats" {{ old('blog_category') == 'Cats' ? 'selected' : '' }}>Cats</option>
                                <option value="Dogs" {{ old('blog_category') == 'Dogs' ? 'selected' : '' }}>Dogs</option>
                                <option value="Lifestyle" {{ old('blog_category') == 'Lifestyle' ? 'selected' : '' }}>Lifestyle</option>
                                <option value="Nutrition" {{ old('blog_category') == 'Nutrition' ? 'selected' : '' }}>Nutrition</option>
                                <option value="Pet" {{ old('blog_category') == 'Pet' ? 'selected' : '' }}>Pet</option>
                                <option value="Toys" {{ old('blog_category') == 'Toys' ? 'selected' : '' }}>Toys</option>
                            </select>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="posted_by" name="posted_by" type="text" class="validate" value="{{ old('posted_by') }}" required>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <div class="file-field input-field">
                                <div class="btn">
                                    <span>Select Posted By Image</span>
                                    <input type="file" name="posted_by_image" id="posted_by_image" accept="image/*">
                                </div>
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload posted by image (optional)">
                                </div>
                            </div>
                            <small class="grey-text">Supported formats: JPEG, PNG, JPG, GIF (Max 2MB)</small>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="posting_date" name="posting_date" type="date" class="validate" value="{{ old('posting_date', date('Y-m-d')) }}" required>

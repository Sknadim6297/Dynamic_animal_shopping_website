...
@section('content')
    ...
    <section class="breadcrumbs-page-wrap">        
        ...
        <section class="wide-tb-70">
            <div class="container">
                <div class="callout-center bg-orange d-flex align-items-center">
                    <div class="row align-items-center g-0 justify-content-between w-100">
                        ...
                        <div class="col-md-auto px-5 mt-4 mb-0 text-md-right mt-md-0">
                            <a href="#" class="btn-theme bg-white">Learn More</a>
                        </div>
                        <div class="col-auto order-lg-first">
                            <img src="{{ asset('frontend/assets/images/dog_callout.png') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="take-care-img">
                            <img src="{{ asset('frontend/assets/images/take_care_img.jpg') }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 mt-5 mt-lg-0">
                        <h1 class="heading-main">
                            <small>Recent Question Answers <i class="pethund_repeat_grid"></i></small>
                            <span>We’ll Take Care</span> of your Pets Friends
                        </h1>

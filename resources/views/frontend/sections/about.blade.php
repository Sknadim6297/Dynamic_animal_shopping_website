...
<main id="body-content">
            ...
            <div class="row">
                <div class="col-lg-4 mb-0">
                    <div class="about-left">
                        <img src="{{ isset($mainAbout) && $mainAbout->vision_image ? asset($mainAbout->vision_image) : asset('frontend/assets/images/about_left.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="about-us-wrap">
                        <h1 class="heading-main light-mode">
                            <small>{{ $mainAbout->years_of_experience ?? 'Quality & Experience' }} <i class="pethund_repeat_grid"></i></small>
                            {{ $mainAbout->main_heading ?? 'Best Pet' }} <span class="txt-blue">{{ $mainAbout->main_heading_highlight ?? 'Care Service' }}</span>
                        </h1>
                        <p>{{ $mainAbout->main_description ?? 'At Animal Pride, we are dedicated to providing exceptional pet grooming and care services. Our experienced team of professional groomers is committed to keeping your pets healthy, happy, and looking their best.' }}</p>

                        @php $items = $mainAbout->why_choose_items ?? null; @endphp
                        ...
                        @else
                            <ul class="list-unstyled icons-listing theme-green paws fw-7 mt-5 txt-blue">
                                <li>Professional grooming services for all pet breeds and sizes</li>
                        ...
                        <div class="about-video">
                            <a href="{{ $mainAbout->video_url ?? 'https://player.vimeo.com/video/7449107' }}" class="popup-video">
        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="bg-fixed pos-rel video-popup">
                        <div class="zindex-fixed pos-rel">
                            <a href="{{ $mainAbout->video_url ?? 'https://player.vimeo.com/video/7449107' }}" class="popup-video"><i class="icofont-play"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-10 mx-auto text-center txt-white">
                    <p>{{ $mainAbout->callout_description ?? 'Experience the best in pet care services at Animal Pride. Our team of professionals is dedicated to providing exceptional grooming and healthcare services for your beloved pets.' }}</p>
    ...
    <!-- Why Choose Us Start -->
    <section class="wide-tb-150 why-choose-bg ">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="why-choose-us">
                        <div class="about-left">
                            <img src="{{ isset($mainAbout) && $mainAbout->why_choose_image ? asset($mainAbout->why_choose_image) : asset('frontend/assets/images/why_choose_img_2.jpg') }}" alt="">
                        </div>
                        <img src="{{ asset('frontend/assets/images/dot_pattern.png') }}" class="pattern-red" alt="">
                        
                        <div class="text">
                            <h3>{{ $mainAbout->why_choose_heading ?? 'We are working for the community' }}</h3>
                            @php $headerSettings = \App\Models\HeaderSettings::first(); @endphp
                            <h3 class="call"><i class="pethund_call"></i> <a href="tel:{{ preg_replace('/[^0-9+]/', '', $headerSettings->phone ?? '(123) 456-789') }}" style="color: inherit; text-decoration: none;">{{ $headerSettings->phone ?? '(123) 456-789' }}</a></h3>
                            <p class="mt-3">{{ $mainAbout->why_choose_community_text ?? '' }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mt-5 mt-lg-0">
                    <div class="why-choose-list">
                        <h1 class="heading-main">
                            ...
                            <span>{{ $mainAbout->why_choose_heading ?? 'Everything Your pet' }}</span> needs in one place
                        </h1>

                        @php $whyItems = $mainAbout->why_choose_items ?? null; @endphp
                        @if(is_array($whyItems) && count($whyItems))
                        ...
                        @else
                            <ul class="list-unstyled">
                                <li>Expert pet grooming professionals with years of experience</li>
                                <li>Premium quality grooming products and equipment</li>
                                <li>Personalized care tailored to each pet's needs</li>
                                <li>Safe and comfortable environment for all pets</li>
                                <li>Comprehensive pet care services in one place</li>
                                <li>Affordable pricing with exceptional value</li>
                            </ul>
                        @endif
                    </div>
                </div>
    ...
    <section class="wide-tb-100 bg-snow pos-rel bg-navy-blue pb-0 clients-rounded-wrap">
                            ...
                            <div class="client-testimonial d-md-flex align-items-center">                                    
                                <div class="testimonial-rounded">
                                    ...
                                    <div>
                                        ...
                                        @else
                                            Animal Pride provides excellent pet grooming services. Our team is dedicated to keeping your pets healthy, happy, and looking their best.
                                        @endif
                                    </div>
                                </div>
                                <div class="client-testimonial-icon order-md-first mt-4 mt-md-0">
                                    ...
                                    @else
                                        <img src="{{ asset('frontend/assets/images/testimonial_thumb_large_1.jpg') }}" alt="{{ $testimonial->client_name }}">
                                    @endif
                                    <h3>
                        ...
                        <div class="item">
                            <div class="client-testimonial d-md-flex align-items-center">                                    
                                <div class="testimonial-rounded">
                                    ...
                                    <div>Animal Pride has been amazing with my dog Max! The groomers are so professional and caring. Max always comes back looking and smelling great. I highly recommend their services to all pet owners.</div>
                                </div>
                                <div class="client-testimonial-icon order-md-first mt-4 mt-md-0">
                                    <img src="{{ asset('frontend/assets/images/testimonial_thumb_large_1.jpg') }}" alt="">
                                    <h3>Sarah Johnson <span>Pet Owner</span></h3>
                                </div>
                            </div>
                        </div>
                        @endforelse
        ...
        <div class="clients-rounded">
            <div class="container">
                <div class="col-sm-12 wow fadeInUp" data-wow-duration="0" data-wow-delay="0.2s">
                    <div class="owl-carousel owl-theme" id="home-clients-rounded">
                        ...
                        <div class="item">
                            <div class="clients-logo">
                                <img src="{{ asset('frontend/assets/images/clients/client2.png') }}" alt="">
                            </div>
                        </div>
                        <!-- Client Logo -->
                        ...
                        <div class="item">
                            <div class="clients-logo">
                                <img src="{{ asset('frontend/assets/images/clients/client3.png') }}" alt="">
                            </div>
                        </div>
                        <!-- Client Logo -->
                        ...
                        <div class="item">
                            <div class="clients-logo">
                                <img src="{{ asset('frontend/assets/images/clients/client4.png') }}" alt="">
                            </div>
                        </div>
                        <!-- Client Logo -->
                        ...
                        <div class="item">
                            <div class="clients-logo">
                                <img src="{{ asset('frontend/assets/images/clients/client5.png') }}" alt="">
                            </div>
                        </div>
                        <!-- Client Logo -->
                        ...
                        <div class="item">
                            <div class="clients-logo">
                                <img src="{{ asset('frontend/assets/images/clients/client6.png') }}" alt="">
                            </div>
                        </div>
                        <!-- Client Logo -->
